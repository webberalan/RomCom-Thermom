...
In the above screenplay and others, I found that the ‘score’ tends to not fluctuate very much, providing more of a monitored tone of the screenplay, whereas the ‘magnitude’ has its peaks and valleys, more in the tradition of Vonnegut’s story shape analysis.  I will be providing [Tableau-generated visualizations](https://public.tableau.com/views/RomComThermom/RomComThermomDashboard?:language=en-US&:display_count=n&:origin=viz_share_link) of my selected examples in the near future, in addition to the detailed JSON files available on GitHub.
